...
export default function LandingSetup() {
  ...
  const fullApiKeySnippet = {
    HTML: `<!-- Paste before </body> -->\n<script\n  src="http://localhost:3000/widget.js"\n  data-api-key="pk_live_f01cfbae8c99c62d5dbb0ebc10a0d1ae8f2d516bf5de8d2a"\n  data-api-url="http://localhost:3000/api/chat"\n></script>`,
    React: `<!-- public/index.html → before </body> -->\n<script\n  src="http://localhost:3000/widget.js"\n  data-api-key="pk_live_f01cfbae8c99c62d5dbb0ebc10a0d1ae8f2d516bf5de8d2a"\n  data-api-url="http://localhost:3000/api/chat"\n></script>`,
    Django: `{# base.html → before </body> #}\n<script\n  src="http://localhost:3000/widget.js"\n  data-api-key="pk_live_f01cfbae8c99c62d5dbb0ebc10a0d1ae8f2d516bf5de8d2a"\n  data-api-url="http://localhost:3000/api/chat"\n></script>`,
    PHP: `<!-- footer.php → before </body> -->\n<script\n  src="http://localhost:3000/widget.js"\n  data-api-key="pk_live_f01cfbae8c99c62d5dbb0ebc10a0d1ae8f2d516bf5de8d2a"\n  data-api-url="http://localhost:3000/api/chat"\n></script>`
  };
            ...
            <div className="w-full max-w-lg rounded-xl overflow-hidden border border-white/10 bg-[#050505] shadow-2xl flex flex-col">
              ...
              <div className="relative bg-[#050505] p-6 text-sm font-mono leading-loose overflow-x-auto min-h-[16rem]">
                ...
                <div className="text-gray-400">
                  ...
                  <br/>
                  <span className="pl-4 text-purple-300">src</span><span className="text-gray-300">="</span><span className="text-green-300">http://localhost:3000/widget.js</span><span className="text-gray-300">"</span>
                  <br/>
                  ...
                  <br/>
                  <span className="pl-4 text-purple-300">data-api-url</span><span className="text-gray-300">="</span><span className="text-green-300">http://localhost:3000/api/chat</span><span className="text-gray-300">"</span>
                  <br/>
                  <span className="text-blue-400">&gt;&lt;/script&gt;</span>
                </div>
              </div>
